...
!function() {
    ...
    template("articleDetail", function($data) {
        "use strict";
        var $utils = this, $escape = ($utils.$helpers, $utils.$escape), id = $data.id, title = $data.title, avatar = $data.avatar, author = $data.author, time = $data.time, banner = $data.banner, $string = $utils.$string, content = $data.content, like = $data.like, $out = "";
        ...
        $out += $escape(banner), $out += '"> </div> </div> <div class="article-body">', 
    ...
    template("articleList", function($data) {
        ...
        return $out += "<ul> ", $each(list, function($value) {
            ...
            $out += $escape($value.id), $out += '"> ', $value.cover ? ($out += ' <div class="bg" style="background-image:url(', 
            $out += $escape($value.cover), $out += ')"></div> ') : $out += ' <div class="bg" style="background-image:url(/assets/imgs/ph_square.png)"></div> ', 
    ...
    template("productDetail", function($data) {
        "use strict";
        var $utils = this, $escape = ($utils.$helpers, $utils.$escape), cover = $data.cover, title = $data.title, summary = $data.summary, $string = $utils.$string, content = $data.content, $out = "";
