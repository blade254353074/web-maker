(function () {
    var upname = window.UMEDITOR_CONFIG.imageFieldName || 'image'
    var utils = UM.utils,
        browser = UM.browser,
        Base = {
...
//                }
    ...
    var Upload = {
        ...
        uploadTpl: '<div class="edui-image-upload%%">' +
            ...
            '<input style=\"filter: alpha(opacity=0);\" class="edui-image-file" type="file" hidefocus name="' + upname + '" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp"/>' +
            '</form>' +
        ...
        submit: function (callback) {
            ...
            var me = this,
                input = $( '<input style="filter: alpha(opacity=0);" class="edui-image-file" type="file" hidefocus="" name="' + upname + '" accept="image/gif,image/jpeg,image/png,image/jpg,image/bmp">'),
                input = input[0];
